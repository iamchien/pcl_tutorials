...
main (int argc, char** argv)
{
  ...
  pcl::io::loadPCDFile<pcl::PointXYZ> ("../../../data/table/table_scene_lms400.pcd", *cloud);
  ...
  writer.write<pcl::PointXYZ> ("../data/output/table_uniform_sampling.pcd", *cloud_filtered, false);
