...
int main(int argc, char** argv)
{
        ...
        pcl::io::loadPCDFile<pcl::PointXYZ>("../../../data/dbscan/cloud_plane.pcd", *cloud);//load the pcd file
        ...
        for (size_t i = 0; i < len; i++)     //convert the type of points to pointxyzrgba and class point
	{
        ...
        writer.write<pcl::PointXYZRGBA> ("../data/output/cloud_color.pcd", *cloud_color, false);
	...
	for (size_t i = 0; i < len; i++)
	{
        ...
        writer.write<pcl::PointXYZRGBA> ("../data/output/cloud_corepts.pcd", *cloud_color, false);
	...
	corecloud1->points.resize(corecloud.size());
        ...
        writer.write<pcl::PointXYZRGBA> ("../data/output/cloud_clusters.pcd", *cloud_color, false);
